  ...
  return (
    <div
      className={classNames(
        'min-w-[175px] pr-2 h-full flex justify-between items-center border-2 border-t-1 border-l-1 border-r-1 border-transparent border-r-dark-300/10 first:border-l-2 last:border-r-2',
        {
